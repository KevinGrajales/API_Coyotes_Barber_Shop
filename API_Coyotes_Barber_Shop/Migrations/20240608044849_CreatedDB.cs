        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Cita_Barbers_BarberId",
                        column: x => x.BarberId,
                        principalTable: "Barbers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Cita_Customers_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "Customers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Cita_Services_ServiceId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Cita_BarberId",
                table: "Cita",
                column: "BarberId");

            migrationBuilder.CreateIndex(
                name: "IX_Cita_CustomerId",
                table: "Cita",
                column: "CustomerId");

            migrationBuilder.CreateIndex(
                name: "IX_Cita_ServiceId",
                table: "Cita",
                column: "ServiceId");

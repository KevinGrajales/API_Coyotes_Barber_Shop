...
namespace API_Coyotes_Barber_Shop.Migrations
{
    ...
    [Migration("20240608005848_integration-services")]
    partial class integrationservices
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API_Coyotes_Barber_Shop.DAL.Entities.Review", b =>
                {
                    b.HasOne("API_Coyotes_Barber_Shop.DAL.Entities.Customer", null)
                        .WithMany()
                        .HasForeignKey("CustomerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("API_Coyotes_Barber_Shop.DAL.Entities.Service", null)
                        .WithMany()
                        .HasForeignKey("ServiceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
